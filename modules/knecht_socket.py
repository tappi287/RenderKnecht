"""
knecht_socket_communication module provides TCP socket connect, send, receive functionality.
...
The class name 'Ncat' is a tribute to the windows version of unix nc that provided
the main funcionality for the original RenderKnecht batch application.
...
class SocketSignals(QtCore.QObject):
    send_start = QtCore.pyqtSignal()
    send_end = QtCore.pyqtSignal()
    recv_start = QtCore.pyqtSignal()
    recv_end = QtCore.pyqtSignal()
    connect_start = QtCore.pyqtSignal()
    connect_end = QtCore.pyqtSignal()
